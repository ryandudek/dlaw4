                ...
                <div class="name-container">
                  <div class="site-name-slogan<?php // print $class; ?>">
                      ...
                      <?php if (!empty($site_name)): ?>
                        <h1 id="the-title" class="site-title<?php //print $class; ?>"><?php print l( $site_name, '', array('attributes' => array('class' => array('site-title-link')))); ?></h1>
                      <?php endif; ?>

                      <?php if (!empty($site_slogan)): ?>
                        <h2 class="site-slogan lead<?php //print $class; ?>"><?php print strip_tags($site_slogan); ?></h2>
                      <?php endif; ?>
...
<footer id="footer-region" class="footer navbar-default">
  <div class="container text-center">
    ...
    <div class="spacer-8 powered-by">Powered by <a href="http://www.openadvocate.org/">DLAW</a></div>
  </div>
</footer>
